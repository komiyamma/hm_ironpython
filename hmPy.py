...
def find1(*args): return _method_proxy("find1", "st", *args);
def find2(*args): return _method_proxy("find2", "st", *args);
def findword(*args): return _method_proxy("findword", "st", *args);
def replace1(*args): return _method_proxy("replace1", "st", *args);
...
def replacedialog(*args): return _method_proxy("replacedialog", "st1s", *args);
def replacedown(*args): return _method_proxy("replacedown", "st1s", *args);
def replaceup(*args): return _method_proxy("replaceup", "st1s", *args);
